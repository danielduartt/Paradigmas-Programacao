...
public class ClassesUpdate  extends JFrame{
    ...
    JLabel label = new JLabel("ATUALIZAR INFORMAÇÕES DA TURMA");
    ...
    public ClassesUpdate(){
        ...
        modeField.setDocument(new JTextFieldLimit(30));
        ...
        add(panel);
        setTitle("Atualizar informações da turma");
        setSize(600, 300);
